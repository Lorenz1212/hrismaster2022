						...
						<div class="header-top">
							...
							<div class="container">
								...
								<div class="topbar bg-primary">
									...
									<!--end::Quick panel-->
									<!--begin::Chat-->
									<div class="topbar-item mr-1" style="display:none">
									...
									<div class="topbar-item">
										<div class="btn btn-icon btn-hover-transparent-white w-sm-auto d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
											<div class="d-flex flex-column text-right pr-sm-3">
												<span class="text-white opacity-50 font-weight-bold font-size-sm d-none d-sm-inline"><?php echo $this->appinfo->admin_fullname() ?></span>
												<span class="text-white font-weight-bolder font-size-sm d-none d-sm-inline"><?php echo $this->appinfo->admin_role() ?></span>
											</div>
										...
										<div class="tab-pane py-5 p-lg-0 show active" id="kt_header_tab_1">
											...
											<div id="kt_header_menu" class="header-menu header-menu-mobile header-menu-layout-default">
												...
												<ul class="menu-nav">
													...
													<li class="menu-item menu-item-active employee" aria-haspopup="true">
										...
										<div class="tab-pane p-5 p-lg-0 justify-content-between" id="kt_header_tab_2">
											...
											<div id="kt_header_menu" class="header-menu header-menu-mobile header-menu-layout-default">
												...
												<ul class="menu-nav">
													<li class="menu-item menu-item-active dashboard" aria-haspopup="true">
														<a href="dashboard" class="menu-link">
															<span class="menu-text">SSS</span>
														</a>
													</li>
													<li class="menu-item menu-item-active employee" aria-haspopup="true">
														<a href="employee" class="menu-link">
															<span class="menu-text">Pag-ibig</span>
														</a>
													</li>
