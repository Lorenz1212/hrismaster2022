...
<html lang="en">
	<!--begin::Head-->
	<head><base href="<?php print base_url(); ?>">
		<meta charset="utf-8" />
		<title><?php echo $this->appinfo->app_company() ?> | </title>
		...
		<!--end::Fonts-->
		<!--end::Layout Themes-->
		<link rel="stylesheet" href="<?= base_url() ?>assets/plugins/custom/fullcalendar/fullcalendar.bundle.css" type="text/css"/>
