<script type="text/javascript">
	...
	var company_title = "<?php echo $this->appinfo->app_company(); ?>";
</script>
...
<script type="text/javascript" class="ajax-reload" src="<?= base_url('assets/admin-js/script.js') ?>"></script>

<script type="text/javascript" src="<?= base_url('assets/js/pages/features/charts/apexcharts.js') ?>"></script>
...
<script type="text/javascript" src="<?= base_url('assets/js/pages/custom/profile/profile.js') ?>"></script>

<script type="text/javascript" src="<?= base_url('assets/admin-js/spreadsheet.js') ?>"></script>
<script type="text/javascript" src="<?= base_url('assets/admin-js/ajax-server-side.js') ?>"></script>
<script type="text/javascript" src="<?= base_url('assets/admin-js/form-controls.js')?>"></script>
<script type="text/javascript" src="<?= base_url('assets/admin-js/exportdata.js') ?>"></script>
	</body>
</html>